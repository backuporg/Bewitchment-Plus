...
public class GobletItemModel<T extends Entity> extends EntityModel<T> {
    public static final EntityModelLayer GOBLET_MODEL_LAYER = new EntityModelLayer(new Identifier(BewitchmentPlus.MODID, "goblet"), "main");
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        root.addChild("group", ModelPartBuilder.create().uv(0, 0).cuboid(-2.5F, 4.0F, -2.5F, 5.0F, 1.0F, 5.0F, new Dilation(0.0F))
