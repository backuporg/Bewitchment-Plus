...
public class CambionEntityModel extends BipedEntityModel<CambionEntity> {
    public static final EntityModelLayer MALE_CAMBION_MODEL_LAYER = new EntityModelLayer(new Identifier(BewitchmentPlus.MODID, "male_cambion"), "main");
    ...
    public static TexturedModelData getTexturedModelDataMale() {
        ...
        root.addChild("body", ModelPartBuilder.create().uv(16, 16).cuboid(-4.0F, 0.0F, -2.0F, 8.0F, 13.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -2.0F, 0.0F));
        ...
        left_arm.addChild("lClaws", ModelPartBuilder.create().uv(0, 34).cuboid(-1.1F, 0.0F, -2.1F, 2.0F, 3.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(2.4F, 11.5F, 0.0F, 0.0F, 0.0F, 0.2793F));
        ...
        right_arm.addChild("rClaws", ModelPartBuilder.create().uv(0, 34).mirrored(true).cuboid(-1.1F, 0.0F, -2.1F, 2.0F, 3.0F, 4.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-2.4F, 11.5F, 0.0F, 0.0F, 0.0F, -0.2793F));
        root.addChild("left_leg", ModelPartBuilder.create().uv(0, 16).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 13.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(1.9F, 11.0F, 0.0F));
        root.addChild("right_leg", ModelPartBuilder.create().uv(0, 16).mirrored(true).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 13.0F, 4.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(-1.9F, 11.0F, 0.0F));
        ...
        head.addChild("snout", ModelPartBuilder.create().uv(21, 35).cuboid(-1.5F, -1.0F, -2.0F, 3.0F, 2.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.5F, -3.9F, 0.4189F, 0.0F, 0.0F));
        head.addChild("upperJaw", ModelPartBuilder.create().uv(21, 41).cuboid(-2.0F, -1.0F, -1.7F, 4.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -1.4F, -4.0F));
        head.addChild("lowerJaw", ModelPartBuilder.create().uv(21, 46).cuboid(-1.5F, -0.5F, -1.6F, 3.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -0.4F, -4.0F));
        ...
        lUpperHorn02.addChild("lUpperHorn03", ModelPartBuilder.create().uv(42, 7).mirrored(true).cuboid(-0.5F, -0.5F, -0.4F, 1.0F, 1.0F, 3.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.0F, 2.4F, -0.1745F, 0.1745F, 0.0F));
        ...
        rUpperHorn02.addChild("rUpperHorn03", ModelPartBuilder.create().uv(42, 7).mirrored(true).cuboid(-0.5F, -0.5F, -0.4F, 1.0F, 1.0F, 3.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.0F, 2.4F, -0.1745F, -0.1745F, 0.0F));
        ...
        rHorn04.addChild("rHorn05", ModelPartBuilder.create().uv(43, 0).mirrored(true).cuboid(-0.5F, -2.1F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, -2.7F, 0.0F, 0.0524F, 0.0F, 0.3142F));
        ...
        lHorn04.addChild("lHorn05", ModelPartBuilder.create().uv(43, 0).cuboid(-0.5F, -2.1F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.7F, 0.0F, 0.0524F, 0.0F, -0.3142F));
        head.addChild("hair01", ModelPartBuilder.create().uv(40, 36).cuboid(-3.99F, 0.0F, -0.1F, 8.0F, 8.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -7.2F, 3.2F, 0.3491F, 0.0F, 0.0F));
        head.addChild("hair00", ModelPartBuilder.create().uv(38, 46).cuboid(-4.01F, 0.0F, -1.0F, 8.0F, 11.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -5.5F, 3.2F, 0.1396F, 0.0F, 0.0F));
    ...
    public static TexturedModelData getTexturedModelDataFemale() {
        ...
        body.addChild("skirtFront", ModelPartBuilder.create().uv(0, 42).cuboid(-4.5F, -0.1F, -0.5F, 9.0F, 9.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 12.9F, -1.7F));
        body.addChild("skirtBack", ModelPartBuilder.create().uv(0, 53).cuboid(-4.5F, -0.1F, -0.5F, 9.0F, 9.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 12.9F, 0.6F));
        ...
        left_arm.addChild("lClaws", ModelPartBuilder.create().uv(0, 34).cuboid(-1.1F, 0.0F, -2.1F, 2.0F, 3.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(1.4F, 11.5F, 0.0F, 0.0F, 0.0F, 0.2793F));
        ...
        right_arm.addChild("rClaws", ModelPartBuilder.create().uv(0, 34).mirrored(true).cuboid(-1.1F, 0.0F, -2.1F, 2.0F, 3.0F, 4.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-1.15F, 11.5F, 0.0F, 0.0F, 0.0F, -0.2793F));
        root.addChild("left_leg", ModelPartBuilder.create().uv(0, 16).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 13.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(1.9F, 11.0F, 0.0F));
        root.addChild("right_leg", ModelPartBuilder.create().uv(0, 16).mirrored(true).cuboid(-2.0F, 0.0F, -2.0F, 4.0F, 13.0F, 4.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(-1.9F, 11.0F, 0.0F));
        ModelPartData head = root.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -2.0F, 0.0F));
        head.addChild("snout", ModelPartBuilder.create().uv(21, 35).cuboid(-1.5F, -1.0F, -2.0F, 3.0F, 2.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -2.5F, -3.9F, 0.4189F, 0.0F, 0.0F));
        head.addChild("upperJaw", ModelPartBuilder.create().uv(23, 41).cuboid(-2.0F, -1.0F, -1.7F, 4.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -1.4F, -4.0F));
        head.addChild("lowerJaw", ModelPartBuilder.create().uv(23, 46).cuboid(-1.5F, -0.5F, -1.6F, 3.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -0.4F, -4.0F));
        ModelPartData lUpperHorn01 = head.addChild("lUpperHorn01", ModelPartBuilder.create().uv(24, 0).mirrored(true).cuboid(-1.0F, -1.0F, -1.8F, 2.0F, 2.0F, 3.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(2.0F, -8.7F, -0.5F, 0.8727F, 0.1745F, 0.0F));
        ModelPartData lUpperHorn02 = lUpperHorn01.addChild("lUpperHorn02", ModelPartBuilder.create().uv(33, 7).mirrored(true).cuboid(-0.5F, -0.6F, -0.5F, 1.0F, 1.0F, 3.0F, new Dilation(0.2F)).mirrored(false), ModelTransform.of(0.0F, 0.0F, 0.9F, -0.3142F, 0.2618F, 0.0F));
        lUpperHorn02.addChild("lUpperHorn03", ModelPartBuilder.create().uv(42, 7).mirrored(true).cuboid(-0.5F, -0.5F, -0.4F, 1.0F, 1.0F, 3.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(0.0F, 0.0F, 2.4F, -0.1745F, 0.1745F, 0.0F));
        ModelPartData rUpperHorn01 = head.addChild("rUpperHorn01", ModelPartBuilder.create().uv(24, 0).mirrored(true).cuboid(-1.0F, -1.0F, -1.8F, 2.0F, 2.0F, 3.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.of(-2.0F, -8.7F, -0.5F, 0.8727F, -0.1745F, 0.0F));
